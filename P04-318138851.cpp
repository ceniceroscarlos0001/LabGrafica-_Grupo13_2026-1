...
int main()
{
	...
	CrearCilindro(25, 1.0f);//índice 2 en MeshList
							//Se modificó el primer número de crear cilindro se paso de 5 a 25
	...
	*/
	...
	glm::mat4 modelaux2(1.0);//Matriz para guardar la posicióm de la cabina
	glm::mat4 modelaux3(1.0);//Matriz para guardar la posicióm de la cabina
	...
	//Pierna 1
	//Articulación1
	model = glm::translate(model, glm::vec3(1.5f, 0.0f, -1.25f));
	model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
	model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));
	glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
	color = glm::vec3(0.0f, 1.0f, 0.0f);
	...
	glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
	meshList[0]->RenderMesh();
	model = glm::translate(model, glm::vec3(0.25f, -0.75f, 0.0f));
	...
	model = modelaux;
	modelaux3 = model;
	model = glm::translate(model, glm::vec3(-0.5f, 0.75f, -0.5f));
	...
	model = modelaux2;
	//Base cola
	model = glm::translate(model, glm::vec3(-1.70f, 0.75f, 0.0f));
